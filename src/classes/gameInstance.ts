...
export class GameInstance {
	...
	load(){
        ...
        const room = new Room(lastGame.currentRoom.id, lastGame.currentRoom.name, lastGame.currentRoom.description, [...lastGame.currentRoom.objects.map(el => getInventory(el))])
        const player = new Player(lastGame.player.id, lastGame.player.type, lastGame.player.name, room, lastGame.player.currentLP, lastGame.player.weight, [...lastGame.player.inventory.map(el => getInventory(el))])
